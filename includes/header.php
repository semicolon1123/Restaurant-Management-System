<?php 
    ...
    define("APPURL", "http://localhost:8012/rawr_tea_restaurant_management");
    define("APPIMAGES", "http://localhost:8012/rawr_tea_restaurant_management/admin-panel/foods-admins/food-images");
?>
...
<head>
    <meta charset="utf-8">
    <title>Rawr tea Restaurant Management System</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
        <a href="" class="navbar-brand p-0">
            <h1 class="text-primary m-0"> <img class="img-fluid" src="food/rawr_tea_logo.png" alt="">Rawr tea</h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0 pe-4">
                ...
                <a href="<?php echo APPURL; ?>/food-menu.php" class="nav-item nav-link">Menu</a>
